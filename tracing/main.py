...
def main():
    texture_path: Path = ASSETS_DIR / "textures" / "clown.png"
    model_path: Path = ASSETS_DIR / "models" / "duck_uv_v2.obj"
    mask_path: Path = ASSETS_DIR / "textures" / "drawable_mask_v2.png"
    ...
    palette: tuple[Color, ...] = ((255, 0, 0), (255, 255, 0), (0,0,255),(255,255,255),(10,10,10),)
