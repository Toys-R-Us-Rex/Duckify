...
- Conducted tests showed that :
  + The librairies used are poorly documented
  + The #link("https://huggingface.co/stabilityai/stable-diffusion-2-depth")[model used ]is not anymore hosted on the given link in their GitHub repo.

== Conclusion
Although TEXTure seemed like a promising solution, it's oldness (2023), lack of documentation (librairies) and unhosted model incline me to conclude against this solution. More recent and promising one's have been found by the GenAI team, thus closing this investigation.
